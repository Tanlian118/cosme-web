...
public interface NewsDAO {
    ...
    @Insert({"INSERT INTO cosme_news(operater_id, news_image, news_title, content_summary, release_time, content)",
            "VALUES(#{entity.operaterId}, #{entity.newsImage}, #{entity.newsTitle}, #{entity.contentSummary}, ",
    ...
    @Select({"<script>",
            ...
            "</if>",
            "</script>"})
    List<NewsEntity> queryByParam(NewsQueryParam queryParam);
